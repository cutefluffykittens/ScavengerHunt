...
class TestTeamLogin(unittest.TestCase):
    ...
    def test_login_second_team(self):
        self.team1.login(database,"username","password")
        self.assertFalse(self.team2.login(database,self.team2.username,self.team2.password), "Error: team1 is already logged in; cannot have two users logged in at once")
