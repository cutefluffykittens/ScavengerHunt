...
class TestTeamEditUsername(unittest.TestCase):
    ...
    def test_edit_username(self):
        self.team1.login("teamname1","password1")
        self.assertTrue(self.team1.edit_username("bestteam"), "Error: username change did not return True")
        self.assertEqual("bestteam", self.team1.username, "Error: username was not changed")
        self.assertEqual("bestteam", self.database.get_current_user(),
...
class TestTeamEditPassword(unittest.TestCase):
    ...
    def test_edit_password(self):
        self.team1.login("teamname1","password1")
        self.assertTrue(self.team1.edit_password("kittens"), "Error: password change did not return True")
