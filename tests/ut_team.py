...
class TestTeamAnswerQuestions(TestCase):
    ...
    def test_correct_one_landmark(self):
        ...
        self.assertEqual(0,HuntUser.objects.get(name="team1").current_landmark_id,
    ...
    def test_team_incorrect_answer(self):
        ...
        self.assertEqual(-1,HuntUser.objects.get(name="team2").current_landmark_id,
    ...
    def test_correct_end_game(self):
        ...
        self.assertEqual(1,HuntUser.objects.get(name="team1").current_landmark_id,
...
class TestTeamRequestClue(TestCase):
    def setUp(self):
        self.t = team.Team()
        self.maker = gamemaker.GameMaker()
        list = Landmark.objects.all().delete()
